            ...
            <div class="col-12 col-lg-12 mx-auto">
                <div class="row">
                    <div class="col-12 col-lg-3">
                        ...
                        <div class="my-3">
                            <a class="text-white footer-icon" href="https://github.com/jinyphp"
                            ...
                            <a class="text-white footer-icon" href="#"
                                target="_blank" rel="noopener noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    width="18" height="18" fill="currentColor" viewBox="0 0 24 24"
                                    class="mr-2">
                            ...
                            <a class="text-white footer-icon" href="https://dribbble.com/adminkit"
                                target="_blank" rel="noopener noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    width="18" height="18" fill="currentColor" viewBox="0 0 24 24"
                                    class="mr-2">
                    ...
                    <div class="col-12 col-sm-6 col-lg">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="pb-1"><a class="text-muted"
                                    href="/integrations/sass-admin-template/">Sass</a></li>
                            <li class="pb-1"><a class="text-muted"
